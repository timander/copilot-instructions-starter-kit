---
name: expert-panel
description: Simulate a panel of named experts (Fowler, Beck, Bloch, Metz, Feathers, etc.) discussing the code or design decision. Use when the user wants multi-perspective stress-testing.
---
