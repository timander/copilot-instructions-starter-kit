---
name: refactor
description: Apply the refactoring catalog (Fowler, Beck Tidy First, Feathers legacy techniques) to existing code. Use when the user wants to improve a specific piece of code without changing its behavior.
allowed-tools: shell
---
