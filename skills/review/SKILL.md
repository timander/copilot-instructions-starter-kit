---
name: review
description: Review code or a PR diff for correctness, design, smells, and missing tests. Use when the user asks for a code review or PR walkthrough.
allowed-tools: shell
---
...
For multi-expert perspectives on the same code, use the `expert-panel` skill.
