---
name: audience
description: Switch the explanation level (learning / working / expert) for a stack mid-session. Use when the user wants a different level of narration for a particular technology.
---
