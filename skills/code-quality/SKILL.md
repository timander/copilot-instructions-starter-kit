---
name: code-quality
description: Offer to add opt-in lint, static-analysis, and coverage tooling for the project's language. Use when the user asks for code review, static-analysis insights, or test coverage.
allowed-tools: shell
---
