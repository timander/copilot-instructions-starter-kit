---
name: diagnose
description: One-shot systematic diagnosis script — understand the problem before suggesting fixes. Use when the user wants to think through a problem step by step rather than have the model jump to a solution.
allowed-tools: shell
---
...
For sustained investigation (read-leaning, no edits), use the `diagnose` agent instead.
